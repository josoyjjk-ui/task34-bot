# 프로젝트 정보
# 검색 키워드: 대시보드, fireant-dashboard, 하니콩, hanikong, 텔레그램 채널,
# 아카이빙, 노션, 구글폼, 에어드랍, GitHub, josoyjjk-ui, 도메인,
# 이벤트 카드, 인사이트, 레포, 웹사이트, 배포, 깃헙페이지

## 운영 채널
- 텔레그램: https://t.me/fireantcrypto
- X(트위터): https://x.com/ROKMCFIREANT
