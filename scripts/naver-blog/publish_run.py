...
PASSWORD = "wnFhT9"
LOG_NO_DELETE = 224245825149
IMAGE_PATH = "/tmp/openclaw/uploads/daily_blog_20260408.png"
POST_TITLE = "📌 [불개미 일일시황] 2026.04.08 수"
POST_TEXT = """📌 불개미 일일시황 | 2026.04.08 (KST)
...
5️⃣ 요약
BTC·ETH ETF 모두 순유출(-$159.10M, -$64.70M)로 매도 압력이 지속됐으나, OI는 BTC +4.38%·ETH +7.81%로 레버리지 확대세가 이어지고 있습니다. DAT 주간 순유입 +$224M으로 제도권 자금 유입 흐름은 유지 중."""
